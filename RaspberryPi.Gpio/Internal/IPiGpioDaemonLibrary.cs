//-----------------------------------------------------------------------
// <copyright file="IPiGpioDaemonLibrary.cs" company="Jon Rowlett">
...
{
    /// <summary>
    /// Mockable interface for calls into the pigpiod interface library (pigpiod_if2).
    /// </summary>
    internal interface IPiGpioDaemonLibrary
    {
        /// <summary>
        ...
        int SetMode(int pi, uint gpio, uint mode);
        ...
        /// </remarks>
        int GpioWrite(int pi, uint gpio, uint level);
    }
}